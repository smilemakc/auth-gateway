...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x18GetApplicationAuthConfig\x12%.auth.GetApplicationAuthConfigRequest\x1a&.auth.GetApplicationAuthConfigResponseB)Z'github.com/smilemakc/auth-gateway/protob\x06proto3"
