...
import { Ban, UserCheck, Eye, Users, Loader2, AlertCircle, Upload } from 'lucide-react';
...
const ApplicationUsersTab: React.FC<ApplicationUsersTabProps> = ({ applicationId }) => {
  ...
  const { data, isLoading, error, refetch } = useApplicationUsers(applicationId, page, pageSize);
