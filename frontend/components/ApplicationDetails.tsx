...
import { ArrowLeft, Edit2, Boxes, Users, Palette, Settings, Copy, Check, ExternalLink, Mail, Globe, Bot, Plug } from 'lucide-react';
      ...
      {activeTab === 'overview' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="lg:col-span-2">
            <ApplicationSecretSection application={application} initialSecret={createdSecret} />
          </div>
