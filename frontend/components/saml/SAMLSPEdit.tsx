...
import { SAMLSPBasicInfoSection } from './SAMLSPBasicInfoSection';
...
const SAMLSPEdit: React.FC = () => {
  ...
  const handleFieldChange = (field: keyof CreateSAMLSPRequest, value: string) => {
        ...
        <div className="border-b border-border pb-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => handleFieldChange('x509_cert', e.target.value)}
              rows={8}
        ...
        <div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFieldChange('metadata_url', e.target.value)}
