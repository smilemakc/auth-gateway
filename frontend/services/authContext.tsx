...
const APP_ID_STORAGE_KEY = 'auth_gateway_current_app_id';
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const login = async (email: string, password: string) => {
    // Admin dashboard login is not app-scoped — remove stale X-Application-ID
    const savedAppId = localStorage.getItem(APP_ID_STORAGE_KEY);
    if (savedAppId) {
    ...
    // Restore app context header after login
    if (savedAppId) {
